...
export const transformMortuaryPatient = (mortuaryPatient: MortuaryPatient): EnhancedPatient => ({
  uuid: mortuaryPatient.person?.uuid || mortuaryPatient.person?.uuid,
  person: {
    display: mortuaryPatient.person?.display || mortuaryPatient.person?.display,
    gender: mortuaryPatient.person?.gender || mortuaryPatient.person?.gender,
    age: mortuaryPatient.person?.age || mortuaryPatient.person?.age,
    deathDate: mortuaryPatient.person?.deathDate || mortuaryPatient.person?.deathDate,
    causeOfDeath: mortuaryPatient.person?.causeOfDeath || mortuaryPatient.person?.causeOfDeath,
  },
